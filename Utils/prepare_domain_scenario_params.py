"""
This file implements functions to deal with datasets and tasks in continual learning for Domain Incremental Learning scenario
"""
...
def set_hyperparameters(dataset,
    ...
    if dataset == "PermutedMNIST":
        ...
        # Related to DIL
        hyperparams["DIL_output_shape"] = 2
