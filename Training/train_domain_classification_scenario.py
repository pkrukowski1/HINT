...
from Utils.prepare_domain_scenario_params import set_hyperparameters
        ...
        if condition:
            ...
            accuracy = calculate_accuracy(
                ...
                parameters={
                    ...
                    "DIL_output_shape": parameters["DIL_output_shape"]
                },
...
def build_multiple_task_experiment(dataset_list_of_tasks,
    ...
    output_shape = parameters["DIL_output_shape"]
    ...
    if parameters["target_network"] == "MLP":
        ...
        raise ValueError(f"Target network {parameters['target_network']} is not supported tight now.")
    if not use_chunks:
...
if __name__ == "__main__":
    ...
    for no, elements in enumerate(
        ...
        parameters = {
            ...
            "DIL_output_shape": hyperparameters["DIL_output_shape"]
        }
