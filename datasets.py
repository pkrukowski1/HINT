...
def set_hyperparameters(dataset,
    ...
    if dataset == 'PermutedMNIST':
        if grid_search:
            hyperparams = {
                'embedding_sizes': [16, 24, 48],
                'learning_rates': [0.001],
                'batch_sizes': [128, 64],
                'betas': [0.001, 0.05, 0.01, 0.1],
