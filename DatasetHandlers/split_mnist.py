...
class PositiveMNISTData(MNISTData):
    
    def __init__(self, data_path, use_one_hot=False, validation_size=5000, use_torch_augmentation=False):
        super().__init__(data_path, use_one_hot, validation_size, use_torch_augmentation)
...
class SplitMNIST(PositiveMNISTData):
    ...
    def __init__(self, data_path, use_one_hot=False, validation_size=1000,
        ...
        super().__init__(data_path, use_one_hot=use_one_hot,
             use_torch_augmentation=False, validation_size=0)
