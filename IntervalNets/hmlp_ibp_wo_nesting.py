...
# to enable interval bound propagation mechanism in an MLP-based hypernetwork when the intersections are non-forced
...
class HMLP_IBP(HMLP, HyperNetInterface):
    ...
    def detach_tensor(self, idx):
        """
        This method detaches an embedding and corresponding perturbation
        vector from the computation graph.
